...
input_data_path = mlflow.artifacts.download_artifacts(run_id="66585519425940cb8db83c43aea6965a", artifact_path="data", dst_path=input_temp_dir)
...
def prophet_training(history_pd):
  ...
  hyperopt_estim = ProphetHyperoptEstimator(horizon=horizon, frequency_unit=unit, metric="smape",interval_width=0.8,
                   country_holidays=country_holidays, search_space=search_space, num_folds=5, max_eval=10, trial_timeout=530,
                   random_state=300783239, is_parallel=run_parallel)
...
with mlflow.start_run(experiment_id="3031282363601977", run_name="Prophet") as mlflow_run:
